...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BoardButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 22)
    ...
    "BoardButton\0clicked\0\0on_BoardButton_clicked\0"
};
...
void BoardButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_BoardButton_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (BoardButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardButton::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject BoardButton::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_BoardButton.data,
      qt_meta_data_BoardButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BoardButton.stringdata))
